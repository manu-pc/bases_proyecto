...
v_socio_id INTEGER := 3;

-- ID de María
v_empleado_id CHAR(9) := '00000000Y';

-- ID de Juan
BEGIN -- Se añade un nuevo autor a la base de datos, Fiódor Dostoievski
INSERT INTO
    creador (
        nombre,
        apellido1,
...
INSERT INTO
    pertenecer_estilo (id_creador, estilo)
VALUES
    (v_autor_id, 'Realismo'),
    (v_autor_id, 'Filosofía');
...
UPDATE
    material_prestamo
SET
    socio_prestamo = v_socio_id,
    empleado_prestamo = v_empleado_id,
    fecha_prestamo = CURRENT_DATE
WHERE
    id_material = v_libro_id;
...
INSERT INTO
    ordenador (id_ordenador, so, modelo)
VALUES
    (DEFAULT, 'Pop OS', 'MSI'),
    (DEFAULT, 'Pop OS', 'MSI'),
...
SET
    socio_prestamo = 1,
    empleado_prestamo = '44445555X',
    fecha_prestamo = '2024-11-30'
WHERE
    id_material = 2000005;
...
BEGIN
INSERT INTO
    creador -- se añade a Aldous Huxley y a Patrick Rothfuss como nuevos creadores.
VALUES
    (
        DEFAULT,
        'Aldous',
...
INSERT INTO
    material_prestamo -- se añaden dos nuevos libros a la base de datos
VALUES
    (
        DEFAULT,
        'libro',
...
UPDATE
    material_prestamo
SET
    socio_prestamo = nuevo_socio,
    empleado_prestamo = '44445555X',
    fecha_prestamo = '2024-12-04'
WHERE
    id_material = nuevo_libro_2;
...
-- se realiza un préstamo de Un mundo feliz a María
UPDATE
    material_prestamo
SET
    socio_prestamo = nuevo_socio,
...
empleado_id CHAR(9) := '44445555X';

-- ID de Carla
BEGIN -- Se añade un nuevo socio a la base de datos
INSERT INTO
    socio (
        nombre,
        apellido1,
...
INSERT INTO
    pertenecer_estilo (id_creador, estilo)
VALUES
    (nuevo_creador_id, 'Distópica'),
    (nuevo_creador_id, 'Sátira');
...
UPDATE
    material_prestamo
SET
    socio_prestamo = nuevo_socio_id,
    empleado_prestamo = empleado_id,
    fecha_prestamo = CURRENT_DATE
WHERE
    id_material = nuevo_libro1_id;

-- Se añade un nuevo ordenador a la base de datos
INSERT INTO
    ordenador (so, modelo)
VALUES
    ('Windows 10', 'Dell') RETURNING id_ordenador INTO nuevo_ordenador_id;

-- El socio empieza a usar el ordenador
UPDATE
    ordenador
SET
    usuario = nuevo_socio_id,
    fecha_prestamo = CURRENT_DATE,
    empleado_prestamo = empleado_id
WHERE
    id_ordenador = nuevo_ordenador_id;
